...
- **Sound effects** — synthesized game-show stings (no audio files, fully offline) for correct/incorrect answers, joker use, a reveal sting, a timer alarm, and a final fanfare, with a mute toggle in presentation mode.
